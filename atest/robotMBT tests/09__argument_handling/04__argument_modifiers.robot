...
...               :OUT: expressions of the keyword. This is to include checks that all data lands
...
Used optional arguments are modified
    ...
    ${one}    ${two}    ${opt}=    Keyword with positional arguments and optional argument    Red    Yellow    Pink
    Should be equal    ${one}    Green
    Should be equal    ${two}    Blue
    Should be equal    ${opt}    Purple
...
Keyword with positional arguments and optional argument
    [Documentation]    *model info*
    ...    :MOD: ${pos1}= [Green, Blue] | ${pos2}= [Blue] | ${pos3}=[Blue, Purple]
...
Keyword with all ${emb_arg} argument styles mixed
    ...
    ...    :OUT: scenario.emb_var == Green | scenario.pos1 == Green
    ...          scenario.pos2 == Blue | scenario.named1 == Orange
    ...          scenario.named2 == Green
